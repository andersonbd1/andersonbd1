...
export CLASSPATH='.:/mydev/andersonbd1/java/lib/*';
...
#cd $dir
#echo "dir: $dir"
cd /mydev/andersonbd1/home/scripts
...
#java -classpath $CLASSPATH org.mozilla.javascript.tools.shell.Main send_msg.js "benanderson.message@gmail.com" message99 "benanderson@benanderson.us" "ping" 
cd $my_pwd
